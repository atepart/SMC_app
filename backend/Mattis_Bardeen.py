...
from numpy import arange, concatenate, imag, real, sqrt, tanh
...
def sigma1(sigma0, f, T, Delta):
    ...
    GG = (
        lambda E, f, T, Delta: (E * (E + h * f * 1e9) + Delta * Delta)
        / sqrt(E * E - Delta * Delta)
        / sqrt((E + h * f * 1e9) * (E + h * f * 1e9) - Delta * Delta)
    )  # Densities of states
